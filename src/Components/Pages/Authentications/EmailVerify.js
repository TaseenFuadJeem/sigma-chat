...
const EmailVerify = () => {
    ...
    const sentEmail = async () => {
        ...
        Swal.fire({
            position: 'center',
            icon: 'success',
            title: "Verification email sent. Please check your email's primary folder or spam folder",
            showConfirmButton: true,
        })
        ...
        <div>
            {
                ...
                sending ?
                    ...
                    <div class="flex items-center justify-center min-h-screen p-5 bg-gray-500 min-w-screen">
                        <div class="max-w-xl p-8 text-center text-gray-800 bg-white shadow-xl lg:max-w-3xl rounded-3xl lg:p-12">
                            <h3 class="text-2xl">Thanks for signing up for Sigmaa!</h3>
                            ...
                            <div class="mt-4">
                                <button onClick={() => sentEmail()} class="btn btn-primary capitalize text-white">Click to Verify Email</button>
                            </div>
                        </div>
                    </div>
